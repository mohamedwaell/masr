  ...
  return (
    <div>
      ...
      <div className="p-6 mt-[10vh] max-w-4xl mx-auto text-center">
        ...
        <h1 className="text-sm md:text-lg text-gray-100 mb-4">
          {monument.fullDescription.achievements}
        </h1>
        <h2 className="text-sm md:text-lg text-[#8392e2] mb-4">
          {monument.fullDescription.family}
        </h2>
        <div className="mt-10">
